...
//        copyBtn
//            .adhere(toSuperview: contentBgView)
//            .setImage(UIImage(named: "copy-f"), for: .normal)
////            .backgroundColor(.black)
////            .setTitle("Copy", for: .normal)
////        copyBtn.setTitleColor(.white, for: .normal)
////        copyBtn.titleLabel?.font = UIFont(name: "Futura-Medium", size: 13)
//        copyBtn.snp.makeConstraints {
//            $0.bottom.equalTo(resultTextView.snp.bottom)
//            $0.right.equalTo(resultTextView.snp.right)
//            $0.width.equalTo(40)
//            $0.height.equalTo(40)
//        }
...
//        favoriteBtn
//            .adhere(toSuperview: contentBgView)
//            .setImage(UIImage(named: "Collections-1"), for: .normal)
////            .backgroundColor(.black)
////            .setTitle("Fav", for: .normal)
////        favoriteBtn.setTitleColor(.white, for: .normal)
////        favoriteBtn.titleLabel?.font = UIFont(name: "Futura-Medium", size: 13)
//        favoriteBtn.snp.makeConstraints {
//            $0.bottom.equalTo(resultTextView.snp.bottom)
//            $0.right.equalTo(copyBtn.snp.left).offset(-10)
//            $0.width.equalTo(40)
//            $0.height.equalTo(40)
//        }
...
//                    ZKProgressHUD.showSuccess("已经收藏到收藏夹!")
//                }
//            }
//        } else {
//            ZKProgressHUD.showMessage("请先输入有效文字")
//        }
//
//    }
//
