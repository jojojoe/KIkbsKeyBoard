...
class KIkbsMainToolBar: UIView {
    ...
    func loadData() {
        let btn1 = KIkbsToolItem(iconStr: "", titleStr: "Transform", type: .transform)
        let btn2 = KIkbsToolItem(iconStr: "", titleStr: "Special", type: .special)
        let btn3 = KIkbsToolItem(iconStr: "", titleStr: "Keybord", type: .keyborad)
        let btn4 = KIkbsToolItem(iconStr: "", titleStr: "TextCard", type: .textCard)
        let btn5 = KIkbsToolItem(iconStr: "", titleStr: "Setting", type: .setting)
