...
extension KIkFontSelectV {
    func setupView() {
        ...
        collection?.register(KIkFontSelectVCell.self, forCellWithReuseIdentifier: "KIkFontSelectVCell")
...
extension KIkFontSelectV: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "KIkFontSelectVCell", for: indexPath) as? KIkFontSelectVCell ?? KIkFontSelectVCell()
...
extension KIkFontSelectV: UICollectionViewDelegateFlowLayout {
...
extension KIkFontSelectV: UICollectionViewDelegate {
...
class KIkFontSelectVCell: UICollectionViewCell {
